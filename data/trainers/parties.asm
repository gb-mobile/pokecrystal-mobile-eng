...
IF DEF (_PINK)
	...
	db 81, CLEFAIRY,    METRONOME, LIGHT_SCREEN, REFLECT, TRI_ATTACK
	db 73, GENGAR,     SLUDGE_BOMB, SHADOW_BALL, TOXIC, PSYCHIC_M
	db 75, KANGASKHAN,    DIZZY_PUNCH, ZAP_CANNON, REST, FAINT_ATTACK
